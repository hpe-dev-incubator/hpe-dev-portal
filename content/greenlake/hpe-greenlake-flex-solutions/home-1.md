...
sidebar:
  - label: "Overview"
    href: "#overview"
  - label: "Why Hybrid Observability?"
...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
  <div style="flex: 1; padding-right: 15px; min-width: 200px;">
    <p id="overview" style="font-size: 22px;">
  ...
  <div class="video-container" style="flex: 1; max-width: 40%; min-width: 200px; text-align: center;">
    <iframe src="https://www.youtube.com/embed/3Jp4MbsNydM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width: 80%; height: 200px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);"></iframe>
  </div>
</div>
