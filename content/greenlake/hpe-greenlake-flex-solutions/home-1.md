...
<div style="text-align: center; margin: 20px 0;">
  <a href="/greenlake/hpe-greenlake-flex-solutions/why-greenLake-flex-solutions" style="background-color: #01a982; color: white; padding: 10px 20px; border-radius: 20px; text-decoration: none; display: inline-flex; align-items: center; gap: 10px;">
  ...
  <tbody>
    ...
    <tr>
      <td style="border: 1px solid black; padding: 8px; text-align: center;">
        ...
        <span style="display: block; margin: 0; font-size: 20px; font-weight: bold;">Step 10: Creating a customized dashboard</span>
      </td>
    </tr>
  </tbody>
</table>
