...
**_Editor's Note: You can find Part 1 of this series [here](https://developer.hpe.com/blog/fast-data-processing-pipeline-for-predicting-flight-delays-using-apache-/)_**
...
![Saved model with streaming data](assets/saved-model-with-streaming-data.png)
...
![Immediate access to operational and analytical data in MapR](assets/immediate-access-to-operational-analytical-data.png)
...
3.        (In the 3rd blog) A Spark streaming application subscribed to the second topic:
  1.        Stores the input data and predictions in MapR Database
