...
For those looking for more mind-stimulating activities, there will be 4 Hack Shack challenges this year focused on the HPE GreenLake edge-to-cloud platform.  They will center on the HPE GreenLake Aruba Central API, the Data Services Cloud Console API, the Compute Ops Management API and the Private Cloud Enterprise. These are perfect for those who’d like some hands-on experience in working with these APIs. 
