...
2. A variable to generate the access token for the API authentication:
   ...
   * URL: **https://sso.common.cloud.hpe.com/as/token.oauth2**
   ...
   ![](/img/2022-10-24-11_51_57-hpe-com-using-infinity-uql-native-api-calls-grafana-—-mozilla-firefox.png)
...
3. A variable for the carbon footprint report ID:   
   ...
   * Column 1: **reportDataUri**
   ...
   ![](/img/2022-10-24-11_53_38-hpe-com-using-infinity-uql-native-api-calls-grafana-—-mozilla-firefox.png)
