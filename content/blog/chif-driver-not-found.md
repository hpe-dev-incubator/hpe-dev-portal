...
The Channel Interface (CHIF) driver is an HPE proprietary driver allowing  in-band communication between an Operating System (OS) and the Insight Lights Out (iLO) chip within HPE ilO based servers.
