...
* **TokenIssuerURL:** This variable is the URL of the Token Issuer you ontain when you create your personal API client credentials from the HPE GreenLake GUI for your workspace.
...
>
> **Note:** Access bearer tokens expire after 15 minutes for HPE GreenLake platform tokens. Run the *Generate AccessToken* API request or the *Generate AccessToken with TokenIssuerURL* again to refresh the token before or after it expires.
