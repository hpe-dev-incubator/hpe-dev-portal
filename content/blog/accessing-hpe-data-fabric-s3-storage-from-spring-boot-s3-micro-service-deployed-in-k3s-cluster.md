...
In this blog, checkout existing Spring Boot application from [Git](https://github.hpe.com/kiran-mavatoor/df-s3-springboot-k3s-demo) , customise it and execute. 
