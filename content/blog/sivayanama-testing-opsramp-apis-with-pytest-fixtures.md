...
Python Decorators is a very powerful and convenient way to alter behavior of functions. For more details, refer to [Python Decorators](https://www.geeksforgeeks.org/decorators-in-python).
