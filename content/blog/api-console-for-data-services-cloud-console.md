...
The access token have a limited lifetime (about 720 seconds or 2 hours). Once it expires, the application must use the refresh token and the refresh API to obtain the valid access tokens
