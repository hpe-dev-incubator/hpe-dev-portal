...
> **Note:** that this conversion will not be required once the open-source tool such openapi-generator-cli eventually support OpenAPI 3.1 Standard spec file in the future. If you are using OpenAPI generator tool such as listed here, you may not required to use the conversion as documented in this blog.
