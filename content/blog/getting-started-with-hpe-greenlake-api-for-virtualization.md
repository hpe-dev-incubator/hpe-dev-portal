...
This blog post introduces you to the new set of HPE GreenLake API for virtualization, which is part of data services family APIs for GreenLake. This is the APIs set to support resources from an on-premises hypervisor, that includes VMware (6.7.X, 7.X and 8.X), as well as for cloud-public-providers such as AWS Elastic Cloud Compute and Microsoft Azure Virtual Machines. This API set will evolve throughout next release in the future. The March 2024 announcement introduces V1Beta1 of the API version. This set of APIs is documented at HPE GreenLake Developer [website ](https://developer.greenlake.hpe.com) and it is available for download as Open API 3.1.X specification in JSON file.  
