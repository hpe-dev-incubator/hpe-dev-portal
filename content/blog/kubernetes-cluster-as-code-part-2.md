...
Below is the code block for adding **helm** community provider. Please refer to Kubernetes Cluster as Code - Part 1 blog post for details regarding **hpegl_caas_cluster** data source.
