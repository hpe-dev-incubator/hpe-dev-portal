...
3. On the upper right side of the Metrics tab, click the **Settings** icon to _View Monitoring Configuration_, such as the monitored metrics, the thresholds, and the availability monitor.
