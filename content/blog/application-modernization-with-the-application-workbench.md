...
HPE Ezmeral also offers the HPE Ezmeral Application Workbench for those who wish to **refactor** their code. The Workbench helps you rebuild or redesign application architecture while preserving their scope and specifications. Once you have built your new application, it can be easily deployed on the HPE Ezmeral Container Platform and leverage the HPE Ezmeral Data Fabric.

Finally, for those who prefer to **Replace** their application, HPE Ezmeral software is tested with a large partner ecosystem. Our partners offer modern applications through the HPE Ezmeral Marketplace that can be used to replace legacy applications.  
