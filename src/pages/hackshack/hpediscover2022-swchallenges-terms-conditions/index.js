    ...
    <Layout background="/img/BackgroundImages/generic-background.png">
      ...
      <Box align="start" width="xlarge" direction="column">
        ...
        <Text size="xlarge">
          ...
          (“Event”) attendees who wish to complete the HPE Hack Shack Software
          Challenge (“Challenge”) to participate in the HPE Software Challenge
          Giveaway (“Program”) for a chance to win a CanaKit Raspberry PI 4
          Extreme Kit (USD $140.00) (“Prize”), subject to the terms and
        ...
        <Text size="xlarge">
          ...
          2022 at 11:00 AM Pacific Time and ends at 4:00 PM Pacific Time on June
          29, 2022, or when the Program budget has been reached, whichever is
          earlier (the “Program Period”). Entries submitted before or after the
          Program Period will not be eligible for the Prize. HPE’s computer is
        ...
        <Text size="xlarge">
          ...
          the Program Period, participants attending the Event in person may be
          considered eligible for the Prize. LIMIT ONE (1) PRIZE PER
          PERSON/ENTRY WHILE SUPPLIES LAST. Participants who attend the Event
          virtually may take the Challenge but will not be eligible to receive a
          Prize. The Prize (approximate retail value: $140.00) is subject to
          ...
          receive a token key from the HPE Hack Shack counter desk in the Event
          show floor. At the Challenge website, participants must select the
          Challenge card of their choice, click on the “Challenge me!” button,
          and fill in and submit the registration form with their valid name,
          email address, company name, and token key. Participants that submit
          the registration form will receive an email providing a link to the
          Challenge. Participants must then complete the Challenge and its
          accompanying quiz and submit their entry via the Challenge form during
          the Program Period.
        </Text>
        <br />
        <Text size="xlarge">
          6. <strong>PRIZE:</strong> Interested parties who merely complete the
          Challenge or submit an entry are not guaranteed a Prize. The total
          estimated retail value of each Prize is USD $140.00. HPE will give
          away a total of six (6) Prizes, with a total estimated retail value of
          USD $840.00. At the end of the Program Period, six (6) potential
          winners will be selected from all eligible entries received during the
          Program Period. A panel of two (2) HPE judges will select the six (6)
          winners who they determine have submitted the best Challenge entries
          based on the following criteria: Completeness and accuracy of
          responses to the quiz. Odds of winning depend on the total number of
          eligible entries received during the Program Period. Should you be
          awarded a Prize, it shall be your responsibility to claim the Prize by
          attending the HPE Hack Shack celebration party on Wednesday, June 29,
          2022 between 5:00 PM Pacific Time and 6:00 PM Pacific Time in the HPE
          Hack Shack zone in the Event show floor. In order to win a Prize,
          participants must be present at the HPE Hack Shack celebration at the
          time the winners are announced. Failure to be present will result in
          forfeiture of the Prize, and an alternate winner may be selected from
        ...
        <Text size="xlarge">
          ...
          extent permitted by applicable law shall not be liable for any act or
          default by a third party. All third party trademarks are the property
          of their respective owners. The company(ies) that own the trademarks
          for the Prize are not affiliated with HPE and are not sponsors of,
          have not endorsed, and are not participants in the Program.
        </Text>
        <br />
        <Text size="xlarge">
