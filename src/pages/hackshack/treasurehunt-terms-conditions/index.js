  ...
  return (
    <Layout background="/img/BackgroundImages/generic-background.png">
      ...
      <Box align="start" width="xlarge" direction="column">
        ...
        <br />
        <Text size="xlarge">
          3. <strong>PROGRAM PERIOD:</strong> The Program begins on May 15, 2022
          at 12:00 AM Pacific Time and ends at 11:59 PM Pacific Time on May 21,
          2022, or when the Program budget has been reached, whichever is
