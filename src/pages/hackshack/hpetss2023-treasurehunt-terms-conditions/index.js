      ...
      <Layout background="/img/BackgroundImages/generic-background.png">
        ...
        <Box align="start" width="xlarge" direction="column">
          <Box align="start">
            ...
            >
              HPE Developer Hack Shack Treasure Hunt – HPE Technology &
              Solutions Summit EMEA 2023
            </Heading>
          ...
          <br />
          <Text size="xlarge">
            2. <strong>INTRODUCTION:</strong> HPE invites HPE Technology &
            Solutions Summit EMEA 2023 (“Event”) attendees who wish to complete
            the HPE Developer Community Hack Shack Treasure Hunt (“Treasure
            Hunt”) to participate in the HPE Developer Community Hack Shack
            Treasure Hunt Giveaway (“Program”) for a chance to win an Amazon
            Echo Dot (30.00 Euros) (“Prize”), subject to the terms and
          ...
          <br />
          <Text size="xlarge">
            3. <strong>PROGRAM PERIOD:</strong> The Program begins on May 22,
            2023 at 12:00 PM Central European Time and ends at 10:00 AM Central
            European Time on May 25, 2023 (the “Program Period”). Entries
            submitted before or after the Program Period will not be eligible.
            HPE’s computer is the official time-keeping device for the Program.
          </Text>
          <br />
          <Text size="xlarge">
            ...
            Employees of the following entities are ineligible for this
          ...
          <br />
          <Text size="xlarge">
            5. <strong>HOW TO ENTER:</strong> By completing the Treasure Hunt
            during the Program Period, participants attending the Event in
            person may be considered eligible for the Prize. LIMIT ONE (1) PRIZE
            PER PERSON/ENTRY WHILE SUPPLIES LAST. The Prize is subject to these
            Terms and Conditions. In order to enter the Program, participants
            ...
            phone, or (ii) accessing the HPE Developer Community Hack Shack
            website via the link provided by HPE. At the HPE Developer Community
            Hack Shack website, participants must then select the Treasure Hunt
            card and click on the “Hunt for Treasure!” button. Participants must
            then complete the Treasure Hunt quiz by exploring the HPE Developer
            Community’s rich ecosystem and submit their entry via the Treasure
            Hunt form during the Program Period.
          </Text>
          <br />
          <Text size="xlarge">
            6. <strong>PRIZE:</strong> Interested parties who merely complete
            the Treasure Hunt form or submit an entry are not guaranteed a
            Prize. The total estimated retail value of each Prize is 30.00
            Euros. HPE will give away a total of three (3) Prizes, with a total
            estimated retail value of 90.00 Euros. At the end of the Program
            Period, three (3) potential winners will be selected from all
            eligible entries received during the Program Period. A panel of two
            (2) HPE judges will select the three (3) winners who they determine
            have submitted the best Treasure Hunt entries based on the following
            criteria: Completeness, accuracy of responses, and date/time of the
            submission. Odds of winning depend on the total number of eligible
            entries received during the Program Period. Should you be awarded a
            Prize, it shall be your responsibility to claim the Prize by
            visiting the HPE GreenLake booth on Thursday, May 25, 2023 between
            12:15 PM Central European Time and 12:45 PM Central European Time in
            the Event show floor. In order to win a Prize, participants must be
            present at the HPE GreenLake booth at the time the winners are
            announced. Failure to be present will result in forfeiture of the
            Prize, and an alternate winner may be selected from among the
          ...
          <Text size="xlarge">
            ...
            Gmail, Hotmail, and other email domains not registered to HPE (for
            employees) or your company (for external participants). Please speak
          ...
          <Text size="xlarge">
            ...
            applicable). HPE employees are expected to abide by the SBC and all
            other HPE policies. Failure to do so will negate an employee’s
            eligibility to participate in this Program and/or to redeem the
            Prize.
          </Text>
          <br />
          <Text size="xlarge">
          ...
          <Text size="xlarge">
            ...
            property of their respective owners. Amazon is not affiliated with
          ...
          <Text size="xlarge">
            ...
            <Anchor
              ...
              rel="noreferrer noopener"
            >
              https://hpe.sharepoint.com/teams/CorporateStdDMT/Approved/HPE002-03.pdf 
            </Anchor>
