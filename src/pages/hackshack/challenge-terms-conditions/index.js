    ...
    <Layout background="/img/generic-background.svg">
      ...
      <Box align="start" width="xlarge" direction="column">
        ...
        <Text size="xlarge">
          ...
          wish to complete the HPE Hack Shack coding challenge (“Challenge”) to
          participate in the HPE Coding Challenge Giveaway (“Program”) for a
          chance to win a fifty dollar (USD $50.00) e-gift card for HPE branded
          merchandise (“Prize”), subject to the terms and conditions below
        ...
        <Text size="xlarge">
          ...
          Prize (approximate retail value: $50.00) is subject to these Terms and
          Conditions. In order to enter the Program, participants must access
          the Challenge website via the link provided by HPE. At the Challenge
          website, participants must then select the Challenge card, click on
          the “Challenge me” button, and fill in and submit the registration
          form with their valid name, email address, and company name.
          Participants that submit the registration form will receive an email
          providing a link to the Challenge. Participants must then complete the
          Challenge and its accompanying quiz and submit their entry via email
          to{' '}
          <Anchor
          ...
          participant (i) represents and warrants that he/she has the full power
          and authority to submit content to HPE and to grant any and all
          associated rights to the content listed herein; (ii) hereby assigns
          all right, title, and interest in and to the content submitted in
          their Challenge entry to HPE; (iii) acknowledges that the content
          submitted will belong to HPE and will be hosted on the HPE Developer
          Community, an open-source community, for the use of all its registered
          members; (iv) acknowledges that each participant is responsible for
          any malware, virus, or malicious code found in the content submitted
          by such participant; and (v) represents and warrants that, except for
          any open-source components contained therein, any content submitted
          will be the participant’s original work and will not violate the
        ...
        <Text size="xlarge">
          ...
          estimated retail value of each Prize is USD $50.00. HPE will give away
          a total of three (3) Prizes, with a total estimated retail value of
          USD $150.00. No later than fourteen (14) business days after the end
          of the Program Period, three (3) potential winners will be selected
          from all eligible entries received during the Program Period. A panel
          of three (3) HPE judges will select the three (3) winners who they
          determine have submitted the best Challenge entries based on the
          following criteria: 50% Technical achievement and 50% Completeness.
          ...
          be sent to the potential winners within five (5) business days. Should
          you be awarded a Prize, you will be contacted via the email address
          used in your entry method. It shall be your responsibility to claim
          the Prize within fifteen (15) days of notification from HPE. Failure
          to do so will result in forfeiture of the Prize, and an alternate
          winner may be selected in a random drawing from among the remaining
          eligible entries.
        </Text>
        <br />
        <Text size="xlarge">
