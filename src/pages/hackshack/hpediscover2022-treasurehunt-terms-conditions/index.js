...
const HPEDiscoverTreasureHuntTC = () => {
  return (
    <Layout background="/img/BackgroundImages/generic-background.png">
      ...
      <Box align="start" width="xlarge" direction="column">
        <Box align="start">
          ...
          >
            HPE Developer Hack Shack Treasure Hunt – HPE Discover 2022
          </Heading>
        ...
        <Text size="xlarge">
          ...
          (“Event”) attendees who wish to complete the HPE Developer Hack Shack
          Treasure Hunt (“Treasure Hunt”) to participate in the HPE Developer
          Hack Shack Treasure Hunt Giveaway (“Program”) for a chance to win an
          HPE Developer branded sweatshirt (“Prize”), subject to the terms and
        ...
        <Text size="xlarge">
          ...
          during the Program Period, participants attending the Event in person
          may be considered eligible for the Prize. LIMIT ONE (1) PRIZE PER
          PERSON/ENTRY WHILE SUPPLIES LAST. The Prize is subject to these Terms
          and Conditions. In order to enter the Program, participants must
          access the Treasure Hunt website by either (i) scanning the Treasure
          Hunt QR Code provided in the Hack Shack using their mobile phone, or
          (ii) using one of the designated Treasure Hunt laptops provided in the
          Hack Shack. At the HPE Developer Hack Shack website, participants must
          then select the Treasure Hunt card and click on the “Hunt for
          Treasure!” button. Participants must then complete the Treasure Hunt
          quiz by exploring the Hack Shack area and the HPE Developer
        ...
        <Text size="xlarge">
          ...
          Treasure Hunt form or submit an entry are not guaranteed a Prize. The
          total estimated retail value of each Prize is USD $45.00. HPE will
          give away a total of twelve (12) Prizes, with a total estimated retail
          value of USD $540.00. At the end of the Program Period, twelve (12)
          ...
          the twelve (12) winners who they determine have submitted the best
          Treasure Hunt entries based on the following criteria: Completeness
          and accuracy of responses. Odds of winning depend on the total number
          of eligible entries received during the Program Period. Should you be
...
export default HPEDiscoverTreasureHuntTC;
