    ...
    <Layout background="/img/BackgroundImages/generic-background.png">
      ...
      <Box align="start" width="xlarge" direction="column">
        <Box align="start">
          ...
          >
            HPE Hack Shack Participation Giveaway – HPE Discover 2022
          </Heading>
        ...
        <Text size="xlarge">
          ...
          (“Event”) attendees to participate in the HPE Hack Shack Participation
          Giveaway (“Program”) for a chance to win a prize as further detailed
          below (“Prize”), subject to the terms and conditions below (“Terms and
        ...
        <Text size="xlarge">
          ...
          2022 at 11:00 AM Pacific Time and ends at 3:00 PM Pacific Time on June
          30, 2022, or when the Program budget has been reached, whichever is
        ...
        <Text size="xlarge">
          ...
          order to enter the Program, participants must participate in one (1)
          of the following activities during the Program Period (each, an
          “Activity”):
        </Text>
        <ul>
          <li>
        ...
        <Text size="xlarge">
          ...
          participants who are awarded a Prize will receive (i) up to three (3)
          HPE branded stickers, and (ii) either an HPE branded t-shirt or an HPE
          branded hat depending on the Activity completed as outlined below:
        </Text>
        <ul>
          <li>
        ...
        <Text size="xlarge">
          Eligible participants may receive both a t-shirt and a hat as part of
          the Program by completing one (1) Shirt Activity and one (1) Hat
          Activity during the Program Period. For the sake of clarity, the total
          Prize each participant may win is one (1) t-shirt, one (1) hat, and up
          to three (3) stickers. Once a participant has received the total
