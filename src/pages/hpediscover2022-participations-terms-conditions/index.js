      ...
      <Layout background="/img/BackgroundImages/generic-background.png">
        ...
        <Box align="start" width="xlarge" direction="column">
          ...
          <Text size="xlarge">
            ...
            2022 at 11:00 AM Pacific Time and ends at 3:00 PM Pacific Time on
            June 30, 2022, or when the Program budget has been reached,
          ...
          <ul>
            ...
            <li>
              Attend the Hack Shack celebration evening on Wednesday, June 29
              from 5:00 PM Pacific Time to 6:00 PM Pacific Time at the Hack
          ...
          <Text size="xlarge">
            ...
            participants who are awarded a Prize will receive (i) up to three
            (3) HPE branded stickers, and (ii) either an HPE branded t-shirt or
            an HPE branded hat depending on the Activity completed as outlined
            below:
          </Text>
          <ul>
            <li>
          ...
          <Text size="xlarge">
            ...
            hat, and up to three (3) stickers. Once a participant has received
            the total permitted Prize, the participant may continue to
            participate in the Activities, but will not be eligible to receive
            any further Prize(s). The total estimated retail value of each Prize
            is USD $15.00. The Program budget will not exceed USD $5,325.00 in
